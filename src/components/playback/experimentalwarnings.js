define(['connectionManager', 'globalize', 'userSettings', 'apphost'], function (connectionManager, globalize, userSettings, appHost) {
    ...
    function showBlurayMessage() {
        ...
        var message =
            'Playback of Bluray folders in this app is experimental. Some titles may not work at all. For a better experience, consider converting to mkv video files, or use an NeexTV app with native Bluray folder support.';
    ...
    function showDvdMessage() {
        ...
        var message =
            'Playback of Dvd folders in this app is experimental. Some titles may not work at all. For a better experience, consider converting to mkv video files, or use an NeexTV app with native Dvd folder support.';
    ...
    function showIsoMessage() {
        ...
        var message =
            'Playback of ISO files in this app is experimental. Some titles may not work at all. For a better experience, consider converting to mkv video files, or use an NeexTV app with native ISO support.';
